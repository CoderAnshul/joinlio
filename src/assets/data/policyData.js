const definitions = [
  {
    term: "Processing or Process",
    desc: "any activity that involves the use of Personal Data. It includes obtaining, recording, or holding the data or carrying out any operation or set of operations on the data, including organizing, amending, retrieving, using, disclosing, erasing, or destroying it. Processing also includes transmitting or transferring Personal Data to third parties.",
  },
  {
    term: "Pseudonymization or Pseudonymized",
    desc: "replacing information that directly or indirectly identifies an individual with one or more artificial identifiers or pseudonyms so that the person to whom the data relates cannot be identified without the use of additional information which is meant to be kept separately and secure.",
  },
  {
    term: "Related Policies",
    desc: "the Company's policies, operating procedures, or processes related to this Data Protection Policy and designed to protect Personal Data and available from your line manager or the DPO.",
  },
  {
...
const dataProtectionPrinciples = [
  {
    term: "Lawfulness, fairness, and transparency",
    desc: "Personal data must be processed lawfully, fairly, and in a transparent manner in relation to the Data Subject.",
  },
  {
    term: "Purpose limitation",
    desc: "Personal data must be collected only for specified, explicit, and legitimate purposes.",
  },
  {
    term: "Data minimization",
    desc: "Personal data must be adequate, relevant, and limited to what is necessary in relation to the purposes for which it is processed.",
  },
  {
    term: "Accuracy",
  ...
  {
    term: "Storage limitation",
    desc: "Personal data must not be kept in a form that permits the identification of Data Subjects for longer than necessary for the purposes for which the data is processed.",
  },
  {
    term: "Security, integrity, and confidentiality",
    desc: "Personal data must be processed in a manner that ensures its security using appropriate technical and organizational measures.",
  },
  {
    term: "Transfer limitation",
    desc: "Personal data must not be transferred to another country without appropriate safeguards in place.",
  },
  {
    term: "Data subject's rights and requests",
    desc: "Personal data must be made available to Data Subjects, allowing them to exercise certain rights in relation to their personal data.",
  },
  {
    term: "Accountability",
    desc: "The company must be able to demonstrate compliance with the data protection principles.",
  },
];
...
const lawfulProcessingGrounds = [
  {
    term: "Consent",
    desc: "The Data Subject has given their Consent to the processing of their personal data for one or more specific purposes.",
  },
  {
    term: "Contract performance",
    desc: "Processing is necessary for the performance of a contract with the Data Subject.",
  },
  {
    term: "Legal compliance",
    desc: "Processing is necessary for compliance with a legal obligation.",
  },
  {
    term: "Vital interests",
    desc: "Processing is necessary to protect the vital interests of the Data Subject or another individual.",
  },
  {
    term: "Legitimate interests",
    desc: "Processing is necessary for the purposes of legitimate interests pursued by the Controller or a third party, unless overridden by the Data Subject's interests or rights.",
  },
];
...
const consentDetails = [
  {
    ...
    desc: "Consent requires affirmative action, and silence, pre-ticked boxes, or inactivity will not be sufficient.",
  },
  {
    term: "Withdrawal of consent",
    desc: "A Data Subject must be able to withdraw consent at any time, and the withdrawal must be promptly honored.",
  },
  {
    term: "Separate from other matters",
    desc: "Consent must be clearly separated from other matters if included in a document dealing with other matters.",
  },
];
...
const transparencyDetails = [
  {
    term: "Privacy Notice",
    desc: "A Privacy Notice must be provided to Data Subjects detailing how, why, and by whom their personal data will be processed.",
  },
  {
    term: "Direct collection",
    desc: "When personal data is collected directly from a Data Subject, a Privacy Notice must be provided at the time of collection.",
  },
  {
    term: "Indirect collection",
    desc: "When personal data is collected from third parties, the Data Subject must be notified as soon as possible after collection.",
  },
];
...
const californiaRightsDetails = [
  ...
  {
    right: "Right to know what data is being sold or shared and to whom",
    details: "We do not sell personal information to any third parties.",
  },
  {
    right: "Right to Opt-out of Sale and data sharing",
    details:
      "You have the right to request that the Business does not sell or share your Personal Data to third parties.",
  },
  {
    right: "Right to Opt-out of automated decision making",
    details: "We do not utilise automated decision making.",
  },
  {
    right: "Right to limit disclosure and use of sensitive information",
    details:
...
export {
  ...
  accuracy,
  storageLimitation,
  securityIntegrityConfidentiality,
  reportingPersonalDataBreach,
  transferLimitation,
  dataSubjectRightsRequests,
  accountability,
  recordKeeping,
  trainingAndAudit,
  privacyByDesignAndDPIA,
  processingAndADM,
  directMarketing,
  sharingPersonalData,
  caldicottPrinciples,
  californiaResidentRights,
  californiaRightsDetails,
  validRights,
  changesToPolicy,
};
