    ...
    <div className="px-0 lg:px-20 py-12 my-5 mx-auto min-h-44 flex justify-center">
      ...
      >
        {cards.map((card, index) => (
          <div
            key={index}
            className="flex flex-col min-h-fit pt-10 md:pt-8 xs:min-h-24 lg:min-h-24 relative justify-end overflow-hidden items-start bg-white rounded-3xl shadow-md p-4"
          >
            {/* Card header */}
            <div
