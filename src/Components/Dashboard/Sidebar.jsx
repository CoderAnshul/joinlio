...
const Sidebar = () => {
  ...
  const renderSidebarContent = () => {
    if (userRole === 'institute') {
      return (
        <>
          {/* Navigation Links for Institute */}
          <ul className="space-y-2 flex-1">
            ...
            {/* Plan Management */}
            <li>
              <Link to="/dashboard/plan" className="flex items-center px-4 py-2 rounded hover:bg-blue-700">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd"></path>
                </svg>
                {!isCollapsed && <span className="ml-3">Plan Management</span>}
              </Link>
            </li>
            
            {/* Student Management */}
            <li>
              <Link to="/dashboard/students" className="flex items-center px-4 py-2 rounded hover:bg-blue-700">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"></path>
                </svg>
                {!isCollapsed && <span className="ml-3">Student Management</span>}
              </Link>
            </li>
            
            {/* Rewards Program */}
            {/* <li>
              <Link to="/rewards" className="flex items-center px-4 py-2 rounded hover:bg-blue-700">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                {!isCollapsed && <span className="ml-3">Rewards Program</span>}
              </Link>
            </li> */}
          </ul>
      ...
      // Default navigation links for other roles
      return (
        <>
          <ul className="space-y-2 flex-1">
            {/* <li>
