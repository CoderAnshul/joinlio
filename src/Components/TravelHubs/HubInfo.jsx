...
const HubInfo = ({ category = "travel" }) => {
  ...
  const categoryData = {
    ...
    entrepreneur: {
      'Tools': {
        number: '01',
        description: 'Comprehensive toolkit for planning, launching, and growing your startup.',
        color: 'bg-green-50',
        textColor: 'text-green-800',
        image: tools,
        subCategories: [
      ...
      'Support': {
        number: '02',
        description: 'Comprehensive guidance and assistance for startup success.',
        color: 'bg-blue-50',
        textColor: 'text-blue-800',
        image: support,
        subCategories: [
      ...
      'Services': {
        number: '03',
        description: 'Third-party partnerships and exclusive resources for startup growth.',
        color: 'bg-yellow-50',
        textColor: 'text-yellow-800',
        image: services,
        subCategories: [
          ...
          >
            ...
            >
              <div className='flex justify-between items-center w-full'>
                ...
                <img src={data.image} className='h-12 mr-4' alt={`${section} icon`} />
              </div>
              <motion.span
