  ...
  return (
    <section className="relative pl-5 my-[50px] lg:mt-[150px] flex items-center justify-between h-auto">
      ...
      <div className={`max-w-2xl sm:max-w-lg md:max-w-2xl ${className}`}>
        <h2 className={` text-5xl lg:text-8xl md:!leading-[50px]  lg:!leading-[80px] -ml-2 md:-ml-3  whitespace-nowrap md:text-6xl font-bold text-blue-300 ${className} !text-white`}>
          {title1} <br /> {title2}
        </h2>
