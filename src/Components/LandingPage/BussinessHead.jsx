    ...
    <section className="flex flex-col md:flex-row items-start justify-between px-6 lg:px-20 gap-[10px] py-12 space-y-8 lg:space-y-0">
      ...
      <div className="relative max-w-2xl ">
        ...
        {/* <div className="flex items-start relative mb-14"> */}
            ...
            Be more than a business -  <br />
            <span className="text-textColor">be an enabler of dreams."</span>
            </h1>
        </div>
        ...
        {/* <p className="text-gray-700 text-[16px] leading-[20px] mt-[2vw] max-w-xl"> */}
        Offer your services to empower students and shape their success. By supporting their growth, you expand your reach and inspire the leaders of tomorrow.
        </p>
      </div>
