      ...
      <div className="md:px-[5vw] relative overflow-hidden">
        ...
        <div className="px-6 lg:px-20 gap-[10px]  py-12 ">
          ...
          <p className="text-gray-700 text-[16px] leading-[20px] mt-[2vw] max-w-xl">
            {/* <p className="text-gray-700 text-[16px] leading-[20px] mt-[2vw] max-w-xl"> */}
            Why take our word for it when you can hear directly from businesses
            thriving with JOINLIO? Discover their success stories, see how
            they’ve expanded their reach, and built loyal customer bases—all by
