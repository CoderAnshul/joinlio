      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh] max-w-7xl mx-auto p-6 text-center">
        <div className="bg-blue-50 p-8 rounded-xl max-w-xl ">
          ...
          <p className="text-gray-600 text-lg mb-6 ">
            Thank you for reaching out to Joinlio. We've received your message
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Link
              to="/get-started"
              className="bg-white text-gray-800 px-6 py-3 rounded-lg hover:bg-gray-200 transition-colors duration-200"
            >
              Get Started
            </Link>
          </div>
