...
const SendMessage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Joinlio – We're Here to Help!</title>
        <meta
          name="description"
          content="Need help with Joinlio? Contact us with your questions or support requests. We're here to assist you, let's start a conversation today!"
        />
      </Helmet>
      <div className="flex flex-col lg:flex-row items-start min-h-[80vh] max-w-7xl mx-auto p-6 py-24 gap-12">
        ...
        <div className="md:w-1/3 w-full mt-10 md:mt-0">
          ...
          <p className="text-gray-600 text-lg">
            We're always here to help. Contact us if you need any help with
            Joinlio or have any questions.
          </p>
          <Link
            to="/get-started"
